...
void* YoloObjectDetector::detectInThread() {
  ...
  timeOfImage = headerBuff_[(buffIndex_ + 2) % 3].stamp;
...
void YoloObjectDetector::yolo() {
  ...
  ros::Time timeOfImage = ros::Time(0);
...
void* YoloObjectDetector::publishInThread() {
  ...
  if (num > 0 && num <= 100) {
    ...
    //boundingBoxesResults_.header.stamp = ros::Time::now()-ros::Duration(0.2);
    boundingBoxesResults_.header.stamp = timeOfImage;
